...
import com.mintegral.detailroi.common.base.utils.oaid.interfaces.OnePlusIDInterface;
 ...
 */
public class OnePlusDeviceHelper {
    ...
    public OnePlusDeviceHelper(Context ctx) {
        mContext = ctx;
    }
