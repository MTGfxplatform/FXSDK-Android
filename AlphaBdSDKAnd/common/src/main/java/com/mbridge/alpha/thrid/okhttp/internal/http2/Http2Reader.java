 ...
 */
package com.mbridge.alpha.thrid.okhttp.internal.http2;
...
import com.mbridge.alpha.thrid.okio.ByteString;
import com.mbridge.alpha.thrid.okio.Source;
import com.mbridge.alpha.thrid.okio.Timeout;

import static java.util.logging.Level.FINE;
import static com.mbridge.alpha.thrid.okhttp.internal.Util.format;
import static com.mbridge.alpha.thrid.okhttp.internal.http2.Http2.CONNECTION_PREFACE;
import static com.mbridge.alpha.thrid.okhttp.internal.http2.Http2.FLAG_ACK;
import static com.mbridge.alpha.thrid.okhttp.internal.http2.Http2.FLAG_COMPRESSED;
import static com.mbridge.alpha.thrid.okhttp.internal.http2.Http2.FLAG_END_HEADERS;
import static com.mbridge.alpha.thrid.okhttp.internal.http2.Http2.FLAG_END_STREAM;
import static com.mbridge.alpha.thrid.okhttp.internal.http2.Http2.FLAG_PADDED;
import static com.mbridge.alpha.thrid.okhttp.internal.http2.Http2.FLAG_PRIORITY;
import static com.mbridge.alpha.thrid.okhttp.internal.http2.Http2.INITIAL_MAX_FRAME_SIZE;
import static com.mbridge.alpha.thrid.okhttp.internal.http2.Http2.TYPE_CONTINUATION;
import static com.mbridge.alpha.thrid.okhttp.internal.http2.Http2.TYPE_DATA;
import static com.mbridge.alpha.thrid.okhttp.internal.http2.Http2.TYPE_GOAWAY;
import static com.mbridge.alpha.thrid.okhttp.internal.http2.Http2.TYPE_HEADERS;
import static com.mbridge.alpha.thrid.okhttp.internal.http2.Http2.TYPE_PING;
import static com.mbridge.alpha.thrid.okhttp.internal.http2.Http2.TYPE_PRIORITY;
import static com.mbridge.alpha.thrid.okhttp.internal.http2.Http2.TYPE_PUSH_PROMISE;
import static com.mbridge.alpha.thrid.okhttp.internal.http2.Http2.TYPE_RST_STREAM;
import static com.mbridge.alpha.thrid.okhttp.internal.http2.Http2.TYPE_SETTINGS;
import static com.mbridge.alpha.thrid.okhttp.internal.http2.Http2.TYPE_WINDOW_UPDATE;
import static com.mbridge.alpha.thrid.okhttp.internal.http2.Http2.frameLog;
import static com.mbridge.alpha.thrid.okhttp.internal.http2.Http2.ioException;
import static com.mbridge.alpha.thrid.okio.ByteString.EMPTY;
